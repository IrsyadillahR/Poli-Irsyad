...
<head>
    ...
    <title>Sistem Temu Janji Poliklinik Udinus</title>
    <!-- Favicon-->
...
<body>
    <!-- Responsive navbar-->
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #84a203;">
    ...
    ?>
        <!-- Header-->
        <header class="py-5" style="background-color: #84a203;"> <!-- Ubah Color Banner disini -->
        <div class="container px-5">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    <p class="mb-1">"Saya sangat puas dengan pelayanan di poliklinik ini. Dokter-dokternya sangat ramah dan kompeten. 
                                        Saya merasa didengarkan dengan baik dan mendapat perawatan yang sangat membantu untuk masalah kesehatan saya."</p>
                                    <div class="small text-muted">- Ahmad Fadil, Jakarta</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="d-flex">
                                <div class="flex-shrink-0"><i class="bi bi-chat-right-quote-fill text-success fs-1"></i></div>
                                <div class="ms-4">
                                    <p class="mb-1">"Pengalaman saya di poliklinik ini luar biasa. Stafnya sangat profesional dan suasana di sana sangat mendukung untuk pemulihan. 
                                        Terima kasih kepada tim medis yang telah membantu saya pulih dengan cepat."</p>
                                    <div class="small text-muted">- Siti Nuraini, Surabaya</div>
                                </div>
                            </div>
                        </div>
                    </div>
